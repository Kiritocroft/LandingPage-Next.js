    ...
    <div className='container'>
        <div className='w-full px-4'>
            ...
            <p className='font-medium text-md text-secondary'>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Suscipit, inventore odit. Maiores, impedit vitae? Beatae?
            </p>
            </div>
        </div>
        <div className='w-full lg:w-2/3 lg:mx-auto'>
            <form>
                ...
                <div className='w-full px-4 mb-8'>
                    <label className='text-base text-primary font-bold'>Email</label>
                    <input type="text" className='w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none'/>
                </div>
                <div className='w-full px-4 mb-8'>
